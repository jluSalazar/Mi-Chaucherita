	...
	<header class="bg-blue">
		...
		<div class="date-selection">
			<form action="ContabilidadController" method="get">
				<input type="hidden" name="ruta" value="showAccount"/>
	...
	<main>
		...
		<div class="account-details">
			...
			<div class="account-info">
				...
				<br>
				<p>
					<strong>Total:</strong> $${account.total }
				</p>
			</div>
					...
					<tbody>
						<c:forEach items="${movements}" var="movement">
							<tr>
								...
								<td><a
									href="ContabilidadController?ruta=showUpdateForm&movementID=${movement.id}">Actualizar</a>
									<br> <a
									href="ContabilidadController?ruta=deleteMovement&movementID=${movement.id}">Eliminar</a>
								</td>
							</tr>
						</c:forEach>
					</tbody>
